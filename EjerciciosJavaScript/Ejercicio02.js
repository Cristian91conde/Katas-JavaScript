...
console.log( "precio total sable: " + preciototal);
...
nave1.precioBaseFinal = nave1.precioBase + precioBaseGlobal;
nave2.precioBaseFinal = nave2.precioBase + precioBaseGlobal;
console.log("Precio final de " + nave1.nombre + ": " + nave1.precioBaseFinal);
console.log("Precio final de " + nave2.nombre + ": " + nave2.precioBaseFinal);